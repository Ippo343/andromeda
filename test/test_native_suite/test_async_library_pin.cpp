...
void test_async_library_pin_setUp() {}
void test_async_library_pin_tearDown() {}
...
static std::string stripComments(const std::string& ini)
{
    std::string out;
...
static bool contains(const std::string& haystack, const std::regex& re)
{
...
void run_test_async_library_pin_tests()
{
